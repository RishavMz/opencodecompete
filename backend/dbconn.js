...
const initialize = async() => {
    ...
    await conn.query("CREATE TABLE IF NOT EXISTS QUESTIONS ( ID SERIAL PRIMARY KEY , USERID INTEGER, TITLE TEXT , STATEMENT TEXT , INPUT TEXT , OUTPUT TEXT , LIKES INTEGER DEFAULT 0, DISLIKES INTEGER DEFAULT 0, CORRECT INTEGER DEFAULT 0, WRONG INTEGER DEFAULT 0 , STATUS INTEGER DEFAULT 1, FOREIGN KEY(USERID) REFERENCES USERS(ID) );")
    ...
    await conn.query("CREATE TABLE IF NOT EXISTS BLOGS ( ID SERIAL PRIMARY KEY , USERID INTEGER, CONTENT TEXT, TITLE TEXT, LIKES INTEGER DEFAULT 0 , DISLIKES INTEGER DEFAULT 0 , STATUS INTEGER DEFAULT 1, FOREIGN KEY (USERID) REFERENCES USERs(ID) );")
